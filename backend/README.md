...
## Project Structure
    ...
    ├── test_max_api_clone__24741  # Django project configurations
...
1. Clone this repo and `cd test_max_api_clone__24741`
...
2. Clone this repo and `cd test_max_api_clone__24741`
